            ...
            {seaLayerVisible && (
                ...
                >
                    <Box padding={4} mb={8}>
                        ...
                        >
                            <span>{intl.formatMessage({ id: "forecast.start_date"})} {formatTimestamp(timestamps[0] ?? "")}</span>
                            <span>
            ...
            {totalPrecipLayerVisible && (
                ...
                >
                    <Box padding={4} mb={8}>
                        ...
                        >
                            <span>
                                {intl.formatMessage({ id: "forecast.start_date"})} {formatTimestamp(timestamps2[0] ?? "")}
                            </span>
                            <span>
                                {intl.formatMessage({ id: "forecast.end_date"})}{" "}
            ...
            {precipRateVisible && (
                ...
                >
                    <Box padding={4} mb={8}>
                        ...
                        >
                            <span>
                                {intl.formatMessage({ id: "forecast.start_date"})} {formatTimestamp(timestamps3[0] ?? "")}
                            </span>
                            <span>
                                {intl.formatMessage({ id: "forecast.end_date"})}{" "}
