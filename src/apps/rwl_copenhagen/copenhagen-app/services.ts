...
import { MapConfig, MapConfigProvider, MapConfigProviderOptions, SimpleLayer, GroupLayer } from "@open-pioneer/map";
import { ServiceOptions, PackageIntl } from "@open-pioneer/runtime";
        ...
        return {
            ...
            layers: [
                ...
                new GroupLayer({
                    ...
                    id: "municipal_layers",
                    description: "Municipal boundaries in Roskilde Fjord.",
                    layers: [
